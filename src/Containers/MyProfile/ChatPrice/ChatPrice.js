...
const ChatPrice = (props) => {
    ...
    return (
        <View style={styles.container}>
            ...
            >
                <PriceCard title={'Chat Price'} subText={'Per Message'}
                    price={userData?.messageCharge} onEdit={() => onEdit('0')} />
                <PriceCard title={'Audio Call Price'} subText={'Per Minute'}
                    price={userData?.callCharge} onEdit={() => onEdit('1')} />
                    ...
                    </View>
                    {
                        getPriceList(isSelected).map((item, index) => {
                            return (
                                ...
                                >
                                    {(isSelected == '0' && index == 0) ? <Text style={[styles.options, optionSelected == item && {
                                        opacity: 1
                                    }]}>{`${item}`} </Text>
                                        :
                                        <Text style={[styles.options, optionSelected == item && {
                                            opacity: 1
                                        }]}>{`${item} Dimonds/${isSelected == '0' ? 'reply' : 'mins'} `} </Text>
                                    }
